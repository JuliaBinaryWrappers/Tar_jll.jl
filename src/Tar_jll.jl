...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Tar_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9b64493d-8859-5bf3-93d7-7c32dd38186f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Tar", artifacts_toml) for e in artifacts["Tar"]]
...
if best_platform === nothing
    @debug("Unable to load Tar; unsupported platform $(triplet(platform_key_abi()))")
else
